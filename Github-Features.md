...
**Github is a cloudbased webplatform used to store , track, and collaborate on software code.This document covers GitHub's core features.

---

## 2. What is Github?
**Github is a cloud-based platform where developers store, manage, share and collaborate on software code. Owned by Microsoft, it functions like a social network and highly advanced backup system speciallly tailored for programmers.

---

## 3. Why Github is required?
**Github is required because traditional ways of handling files-like emailing zip folders or using Google Drive-fail completely when applied to software development. Without Github, large -scale software enginneering would be incredibly chaotic, slow, and prne to catastrophic data loss. 

---

## 4. Key Features 

- **Version Control** - Tracks everey change made to a file, allowing you to easily roll back to older versions if a bug is introduced
...
Github offers unmathed collaboration and version control for software development, but it also presents challenges regarding pricing limits, security risks, and a steep learning curve.
...
### Disadvantages
-Steep Learning Curve: Requires a solid understanding of Git command-line tools, which can be highly confusing for beginner
...
GitHub combines repository management, code review, CI/CD automation, and security tooling into a single platform, making it a widely adopted choice for teams managing source code collaboratively.
